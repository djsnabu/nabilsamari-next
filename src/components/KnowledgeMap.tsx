...
const DOMAINS = [
  ...
  { id: "tech", label: "Teknologia & Automaatio", color: "#00C9A7", skills: ["n8n-automaatiot","API-integraatiot","Notion-järjestelmät","Laskutuksen automatisointi","Digitaalinen infrastruktuuri","Sovellustuntemus (Netvisor, Procountor)"], emoji: "⚡" },
